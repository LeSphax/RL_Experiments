...
with tf.variable_scope("model", reuse=False):
    X = tf.placeholder(
        shape=[None, D], dtype=env.observation_space.dtype, name="X")
    activ = tf.tanh
    pi_h1 = activ(fc(X, 'pi_fc1', nh=16, init_scale=np.sqrt(2)))
    pi_h2 = activ(fc(pi_h1, 'pi_fc2', nh=16, init_scale=np.sqrt(2)))
